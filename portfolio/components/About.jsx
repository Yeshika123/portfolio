              ...
              <div className="text-lg mt-12 xl:mt-8">
                ...
                <TabsContent value="qualification">
                  ...
                  <div className="">
                    ...
                    <p className="subtitle max-w-lg max-auto xl:mx-0">
                    In my two-year journey as a technical writing, I've grown from my early experiences to tackling complex projects, continuously improving both technical and soft skills.<br/> Embracing challenges as opportunities, I'm eager to leverage my experiences to contribute meaningfully to future projects and teams.
                    </p>
